        ...
        <li className="max-[320px]:px-2 max-[450px]:px-3 max-[600px]:px-4 px-6 inline-block hover:cursor-pointer">
          <Link href="#about">
            <p className="relative group">
              <span className={`${ currentMenu === "about" ? "text-slate-900" : "" }`}>About</span>
              {/* <span className={`${ currentMenu.about && !currentMenu.portfolio ? "text-slate-900" : "" }`}>About</span> */}
        ...
        <li className="max-[320px]:px-2 max-[450px]:px-3 max-[600px]:px-4 px-6 inline-block hover:cursor-pointer">
          ...
          > 
            <p className="relative group">
              ...
              {/* <span className={`${currentMenu.portfolio && !currentMenu.contact ? "text-slate-900" : ""}`}>Portfolio</span> */}
        ...
        <li className="max-[320px]:px-2 max-[450px]:px-3 max-[600px]:px-4 px-6 inline-block hover:cursor-pointer">
          <Link href="#contact">
            <p className="relative group">
              ...
              {/* <span className={`${currentMenu.contact && !currentMenu.portfolio ? "text-slate-900" : ""}`}>Contact</span> */}
              <span className="absolute -bottom-1 left-0 w-0 h-1 bg-[#D9EAF4] text-[#273448] transition-all duration-500 group-hover:w-full"></span>
            </p>
          </Link>
        </li>
