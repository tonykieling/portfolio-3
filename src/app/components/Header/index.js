      ...
      <nav className="list-none text-center font-bold text-xl text--stone-200 max-[450px]:text-lg max-[320px]:text-base ">
        <li className="max-[320px]:px-2 max-[450px]:px-3 max-[600px]:px-4 px-6 inline-block hover:cursor-pointer">
          <Link 
            href="#about"
          >
            <span className={`pointer-events-none sm:pointer-events-auto ${ currentMenu === "about" ? "text-slate-900 bg-blue-500 rounded-md" : "bg-[blue] text-[#FFF]"} px-3 py-2 hover:bg-blue-500 hover:rounded-md`}>
              About
            </span>
          </Link>
        </li>
        ...
        <li className="max-[320px]:px-2 max-[450px]:px-3 max-[600px]:px-4 px-6 inline-block hover:cursor-pointer">
          <Link href="#portfolio"> 
            <span className={`pointer-events-none sm:pointer-events-auto ${ currentMenu === "portfolio" ? "text-slate-900 bg-blue-500 rounded-md" : "bg-[blue] text-[#FFF]"} px-3 py-2 hover:bg-blue-500 hover:rounded-md`}>
              Portfolio
            </span>
          </Link>
        </li>
        ...
        <li className="max-[320px]:px-2 max-[450px]:px-3 max-[600px]:px-4 px-6 inline-block hover:cursor-pointer">
          <Link href="#contact">
            <span className={`pointer-events-none sm:pointer-events-auto ${ currentMenu === "contact" ? "text-slate-900 bg-blue-500 rounded-md" : "bg-[blue] text-[#FFF]"} px-3 py-2 hover:bg-blue-500 hover:rounded-md`}>
              Contact
            </span>
          </Link>
        </li>
